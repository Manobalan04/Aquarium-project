  ...
  return (
    ...
    <div class="top1">
        ...
        <div id="top1_02">
            ...
            <a href="#" style="color: black;"><i class="fa-solid fa-user" style="color: aqua; -webkit-text-stroke: 2px black;"></i></a>
            <div class="dropdown">
    ...
    <div class="center">
        <p id="center1">Sign In</p>



        <div id="center2">
            <span id="center2_00"><input type="name" placeholder="E-mail/Username" id="center2_01"/></span>
        ...
        <div id="center5">
            ...
            <span><a href="#" id="center5_02">Forget Password?</a></span>
        </div>


        <div id="center6">
            <p><input type="button" value="Log in" id="center6_01"/></p>
        </div>


        <div id="center7">
            <span>Don't have an account?</span>
            <span><a href="D:\Webpage\register_page.html" id="center7_01">Register</a></span>
        </div>    
